...
@section('content')
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Update Assignment</h1>
            <p class="text-gray-600 mt-2">update assignment for {{ $course->code }} - {{ $course->title }}</p>
        </div>
    ...
    <form action="{{ route('instructor.courses.assignments.update', [$course, $assignment]) }}" method="POST"
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $assignment->title) }}"
                            ...
                            placeholder="e.g., Week 1 Quiz - Introduction to Programming" required>
                        @error('title')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Provide a brief overview of the assignment...">{{ old('description', $assignment->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <label
                                class="flex items-start p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition @error('submission_type') border-red-500 @enderror">
                                <input type="radio" name="submission_type" value="file" {{ old('submission_type', $assignment->submission_type) === 'file' ? 'checked' : '' }} class="mt-1">
                                <div class="ml-3">
                            ...
                            <label
                                class="flex items-start p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition opacity-50 hover:pointer-events-none">
                                <input type="radio" name="submission_type" value="text" {{ old('submission_type', $assignment->submission_type) === 'text' ? 'checked' : '' }} class="mt-1" disabled />
                                <div class="ml-3">
                            ...
                            <label
                                class="flex items-start p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition opacity-50 hover:pointer-events-none">
                                <input type="radio" name="submission_type" value="both" {{ old('submission_type', $assignment->submission_type) === 'both' ? 'checked' : '' }} class="mt-1" disabled />
                                <div class="ml-3">
                    ...
                    <div>
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="allow_late_submission" id="allow_late_submission" value="1" {{ old('allow_late_submission', $assignment->allow_late_submission) ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="total_points" id="total_points"
                            value="{{ old('total_points', $assignment->total_points) }}" min="1" max="1000"
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-start p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                            <input type="radio" name="status" value="draft" {{ old('status', $assignment->status) === 'draft' ? 'checked' : '' }} class="mt-1">
                            <div class="ml-3">
                        ...
                        <label class="flex items-start p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                            <input type="radio" name="status" value="published" {{ old('status', $assignment->status) === 'published' ? 'checked' : '' }} class="mt-1">
                            <div class="ml-3">
                        ...
                        <label class="flex items-start p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                            <input type="radio" name="status" value="closed" {{ old('status', $assignment->status) === 'closed' ? 'checked' : '' }} class="mt-1">
                            <div class="ml-3">
