...
@section('content')
    ...
    <nav class="flex mb-6 text-sm text-gray-500">
        ...
        <span class="mx-2">/</span>
        <span class="font-medium text-gray-900">Upload Content</span>
    </nav>

    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Upload Course Content</h1>
    ...
    <form action="{{ route('instructor.courses.content.store', $course) }}" method="POST" enctype="multipart/form-data" id="content-upload-form">
        @csrf
