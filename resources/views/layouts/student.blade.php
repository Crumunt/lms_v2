...
@section('body')
    <div class="layout-container">
        <!-- Enhanced Sidebar -->
        <x-student.layout.sidebar :user="$user" />

        <!-- Main Area -->
        <div class="main-area">
            <!-- Enhanced Header -->
            <x-student.layout.header :user="$user" :currentDate="now()->format('l, F j, Y')"
    ...
    @push('scripts')
        <script>
            ...
            document.querySelectorAll('.bg-white.rounded-xl.p-6').forEach((button, index) => {
                const tooltips = [
            ...
            console.log('CLSU LMS Dashboard loaded successfully! 🎓');
        </script>
    @endpush
