    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-3xl font-bold text-blue-600">{{ $students_stats['total'] }}</div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-3xl font-bold text-green-600">{{ $students_stats['active'] }}
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-3xl font-bold text-purple-600">{{ $students_stats['total_enrolled'] }}</div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div
                                        ...
                                        <span
                                            class="text-white text-sm font-medium">{{ substr(strtoupper($student->detail?->full_name), 0, 2) }}</span>
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">{{ $student->detail?->full_name }}
                                        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="badge {{ $student->status_class }}">
                                    <i class="fas {{ $student->status_badge['icon'] }} mr-1"></i>
